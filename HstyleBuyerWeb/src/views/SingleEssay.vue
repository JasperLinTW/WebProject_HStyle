<template>
    ...
    <div class="column">
        ...
        <hr />
        <div>
            <div v-html="decodeURI(essays.econtent)" class="container-text mx-auto h-100 ">
            </div>
        </div>
...
const getEssayInfo = async () => {
    await axios.get(`https://localhost:7243/api/Essay/${route.params.id}`)
        .then(response => { essays.value = response.data;
