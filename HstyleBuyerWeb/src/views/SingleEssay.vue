<template>
   ...
   <div class="column">
      ...
      <div class="Who">
         By
         <router-link :to="`/Blog/EssaysBlog/${essays.influencerName}`">{{ essays.influencerName }}</router-link>
      </div>
      ...
      <div class="row">
         <div class="col-2">
            ...
            <div style="position: sticky; top: 2%; transform: translate(-10%, 1%)">
               <div class="card d-flex justify-content-center align-items-center" v-for="product in RecoProducts" :key="product.product_Id">
   ...
   <div class="comments-container">
      <form action="">
         <div class="form-group">
            ...
            <input type="text" id="comment-input" class="form-control" placeholder="輸入留言..." v-model="comment" />
            <button class="btn btn-primary" type="button" @click.prevent="postComment()">送出</button>
         </div>
      </form>
      <div class="comments-container">
         <div class="row comments">
            <div class="" v-for="comment in essayComments" :key="comment.commentId">
               <div class="row" style="background-color: #f8f8f8; padding-top: 10px; margin: 10px">
                  <div class="col-1">
                  ...
                  <div class="col-4">
                     ...
                     <i v-if="!comment.commentIsClicked" class="far fa-thumbs-up like-btn" @click="postCommentLike()"></i>
                     <i v-else class="fas fa-thumbs-up like-btn" @click="postCommentLike()"></i>
...
const postCommentLike = (commentId) => {
   ...
   axios
      .post(`https://localhost:7243/api/Essay/comment/Likes/${commentId}`, {}, { withCredentials: true })
      .then((response) => {
         commentIsClicked.value = !commentIsClicked.value;
         getCommentLikes();
      })
...
const postComment = async () => {
   await axios
      .post(`https://localhost:7243/api/Essay/Comment/${route.params.id}`, { comment: comment.value }, { withCredentials: true })
      .then((response) => {
         getComments();
         comment.value = "";
      })
