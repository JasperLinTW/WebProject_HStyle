...
//     filteredQuestions = filteredQuestions.filter((question) => question.qcategoryId == selectedCategoryId.value);
//   }
//   searchResult.value = filteredQuestions.filter((question) => question.answer.toLowerCase().includes(searchKeyword.value.toLowerCase()));
// });
