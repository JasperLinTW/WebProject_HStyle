      ...
      <div class="col-md-4">
        ...
        <div class="input-group">
          <input type="text" class="form-control" id="validationDefaultUsername" aria-describedby="inputGroupPrepend2"
            v-model="member.address" required>
        </div>
      </div>
      <div class="col-md-6">
        <label for="validationDefault03" class="form-label">郵箱：</label>
        <input type="text" class="form-control" v-model="member.email" readonly required>
      </div>
      <div class="col-md-6">
        <label for="validationDefault03" class="form-label">帳號：</label>
        <input type="text" class="form-control" v-model="member.account" readonly required>
      </div>
      <div class="col-md-6">
        <label for="validationDefault03" class="form-label">性別：男</label>
        <input type="text" class="form-control" v-model="member.gender" readonly required>
      </div>
      <div class="col-md-6">
        <label for="validationDefault03" class="form-label">生日：</label>
        <input type="text" class="form-control" v-model="member.birthday" readonly required>
      </div>
      <div class="col-md-6">
        <label for="validationDefault03" class="form-label">H幣的總額：</label>
        <input type="text" class="form-control" v-model="member.totalH" readonly required>
      </div>



      <div class="col-md-6">
        <button class="btn btn-primary " type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample999"
          ...
          <div class="card card-body">
            <form>
              <div class="mb-3">
                ...
                <input type="account" class="form-control" v-model="oldPassword" required>
