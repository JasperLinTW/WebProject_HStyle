...
{    
    ...
    public class SetPassUpdateNoticeRequest : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>Required. Google will provide a generic notification in notification drawer (eg: “A pass in your
        /// Wallet has an update”). When user acts on this notification, they are brought to the pass view, where they
        /// will see this issuer message that tells them where they can find the updated pass. This message should embed
        /// an anchor tag with an issuer hosted URL where the user will first need to login and receive the updated
        /// pass. Please do not put any private data in the URL itself. Issuer should provide up to two anchor tags in
        /// the issuer message.</summary>
