...
class DemoGeneric
{
  ...
  public DemoGeneric()
  {
    keyFilePath = Environment.GetEnvironmentVariable(
        "GOOGLE_APPLICATION_CREDENTIALS") ?? "D:\\Cheng\\Documents\\test\\GoogleWallet\\GoogleWallet\\key\\onyx-silo-406508-0325fb707cd2.json";
  ...
  public string CreateObject(string issuerId, string classSuffix, string objectSuffix)
  {
    ...
    GenericObject newObject = new GenericObject
    {
      ...
      Logo = new Image
      {
        ...
        {
          Uri = "https://upload.wikimedia.org/wikipedia/zh/thumb/b/b2/Taishin.svg/1280px-Taishin.svg.png"
		},
